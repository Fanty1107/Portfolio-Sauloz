  ...
  return (
    ...
    >
      ...
      <nav className="hidden md:flex gap-10 text-sm font-semibold tracking-widest text-zinc-400">
        ...
        <a href="#sobre-mim" className="hover:text-red-500 transition-colors">SOBRE</a>
        <a href="#projetos" className="hover:text-red-500 transition-colors">PROJETOS</a>
        <a href="#clientes" className="hover:text-red-500 transition-colors">CLIENTES</a>
        <a href="#faq" className="hover:text-red-500 transition-colors">FAQ</a>
      </nav>
      <button className="border border-red-600 text-red-500 hover:bg-red-600 hover:text-white px-8 py-2 rounded-md font-bold transition-all duration-300 shadow-[0_0_10px_rgba(220,38,38,0.2)] hover:shadow-[0_0_20px_rgba(220,38,38,0.6)]">
        CONTATO
      </button>
    </motion.header>
  );
